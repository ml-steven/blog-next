    ...
    <div class="app-container">
        <el-form :model="queryParams" ref="queryForm" :inline="true" label-width="68px">
            <el-form-item label="分类名称" prop="sort_name">
                <el-input v-model="queryParams.sort_name" placeholder="请输入文章分类名称" clearable size="small" @keyup.enter.native="handleQuery" />
            </el-form-item>
            <el-form-item>
        ...
        <el-table v-loading="loading" :data="sortList" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="分类名称" align="center" prop="sort_name" :show-overflow-tooltip="true" />
        ...
        <el-dialog :title="title" :visible.sync="open" width="780px">
            <el-form ref="form" :model="form" :rules="rules" label-width="80px">
                <el-row>
                    <el-col :span="12">
                        <el-form-item label="分类名称" prop="sort_name">
                            <el-input v-model="form.sort_name" placeholder="请输入文章分类名称" />
                        </el-form-item>
                    </el-col>
                </el-row>
            </el-form>
...
export default {
    ...
    methods: {
        ...
        getList() {
            this.loading = true;
            getArtSortList(this.queryParams).then((response) => {
            ...
            this.$refs["form"].validate((valid) => {
                if (valid) {
                    if (this.form.id != undefined) {
                        updateArtSort(this.form).then((response) => {
                        ...
                        createArtSort(this.form).then((response) => {
                            if (response.code === 200) {
