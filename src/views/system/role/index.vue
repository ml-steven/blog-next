  ...
  <div class="app-container">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px">
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="角色权值" prop="data_score">
          <el-input-number v-model="form.data_score" controls-position="right" :min="0" :max="maxDataScore-1" />
        </el-form-item>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        data_score:[
          { required: true, message: "角色权值不能为空", trigger: "blur" }
        ]
      }
    };
  },
  ...
  methods: {
    ...
    getRoleMenuTreeselect(role_id) {
      roleMenuTreeselect(role_id).then(response => {
        const {menus,checkedKeys} = response.data
